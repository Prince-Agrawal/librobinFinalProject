...
class MobileFilter extends Component {
  ...
  render() {
    return (
      <div>
        <div class="container" id="mobile-filter-body">
          <div class="row justify-content-end">
            <div class="col-10">
              <h4>Filter By your choice </h4>
            </div>
            <div class="col-2" onClick={this.props.handelMobileFilter}>
          ...
          <div class="row">
            ...
            <div class="col-12 col-sm-4-ml-2">
              {/*<h4>Filter By Your choice <i class="fa fa-times crosssign" aria-hidden="true"></i></h4>*/}
